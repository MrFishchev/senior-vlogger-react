            ...
            <div className="container">
              ...
              <div className="skills slide-in-right">
                ...
                <div className="additional appears-fade-in">
                  ...
                  <p>
                    <span>AWS:</span> ECS, CloudFormation, CDK, DynamoDB,
                    Aurora, EC2, ELB, Lambda, SQS, CloudWatch, AnomalyDetection,
                    SSM, S3, IAM
                  </p>
                  <p>
          ...
          <div className="block contact">
            ...
            <div className="container">
              <div className="whoami">
                ...
                <div className="desc">
                  Hi Friend! I&apos;m a
                  <strong> Senior Software Engineer</strong>. Now I&apos;m on my
                  way to becoming a Software Architect. Let&apos;s make the
                  World a better place. If you want to know about me or
